...
:date: **Date:** Mondays, 5–6PM (1-3 lectures may be at a different times based on expert lecturer availability)

:round_pushpin: **Location:** to be determined
...
- Existing research tools available to students
- How AI has impacted research
- AI initiatives within Penn Med

A little bit about our speakers:

**Dr. Stacey Kassuto** is the Director of Internal Medicine Residency Simulation Education at Penn Medicine. Her research interests include innovative simulation-based education, the use of extended reality and AI in medical education, and communication and interprofessional training across all learner levels.

**Dr. Michael Horst** is the Director of the Learning Health System Data Science Core. His research interests include EMR applications, health systems outcome research, and applied statistical methods in health outcomes research.

**Dr. Danielle Mowery** is the Chief Research Information Office of Penn Medicine and Assistant Professor of Informatics. Her research interests include using natural language processing to support clinical research, analyze disease burden, and help physicians and patients make better decisions at the point of care.

:date: **Date:** Monday, 9/14, 1-2PM
